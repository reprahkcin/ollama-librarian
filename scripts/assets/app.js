    ...
    const API_KEY_REQUIRED = readMetaContent('ollama-api-key-required', 'false') === 'true';
    ...
    const MAX_UPLOAD_BYTES = Number(readMetaContent('ollama-max-upload-bytes', '536870912'));
